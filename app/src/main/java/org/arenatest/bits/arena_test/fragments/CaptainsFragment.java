...
import org.arenatest.bits.arena_test.adapter.OrganisersAdapter;
...
public class CaptainsFragment extends Fragment implements AdapterView.OnItemClickListener{
    org.arenatest.bits.arena_test.adapter.OrganisersAdapter OrganisersAdapter;
    ...
    private void feedData() {
        ...
        Contacts temp2 = new Contacts("Karthik Ramanathan",	"Football","9542981889", R.drawable.karthik,"karthik227.kr@gmail.com");
        ...
        Contacts temp7 = new Contacts("Sushmitha Belede", "Badminton (G)", "8184999840", R.drawable.sushmitha,"susmitha1157@gmail.com");
        ...
        Contacts temp22 = new Contacts("Yashwardhan Singh", "Duathlon", "9030024944", R.drawable.yashwardhan,"yashwardhan95@gmail.com");
        data1.add(temp1);
        data1.add(temp2);
        data1.add(temp3);
        data1.add(temp4);
